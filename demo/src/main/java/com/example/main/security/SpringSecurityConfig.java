...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.httpBasic().disable()
                ...
                .antMatchers(HttpMethod.GET, "/bt/cars/{id}").hasAnyRole("ADMIN", "USER")
                ...
                .antMatchers(HttpMethod.GET, "/bt/cars").hasAnyRole("ADMIN", "USER")
                .antMatchers(HttpMethod.OPTIONS, "/bt/cars").permitAll()
                .antMatchers(HttpMethod.GET, "/bt/masters/{id}").hasAnyRole("ADMIN", "USER")
                ...
                .antMatchers(HttpMethod.GET, "/bt/masters" ).hasAnyRole("ADMIN", "USER")
                .antMatchers(HttpMethod.OPTIONS, "/bt/masters" ).permitAll()
                .antMatchers(HttpMethod.OPTIONS, "/bt/masters" ).permitAll()
                .antMatchers(HttpMethod.GET, "/bt/services/{id}").hasAnyRole("ADMIN", "USER")
                ...
                .antMatchers(HttpMethod.GET, "/bt/services" ).hasAnyRole("ADMIN", "USER")
                .antMatchers(HttpMethod.OPTIONS, "/bt/services" ).permitAll()
                .antMatchers(HttpMethod.GET, "/bt/works/{id}").hasAnyRole("ADMIN", "USER")
                ...
                .antMatchers(HttpMethod.GET, "/bt/works" ).hasAnyRole("ADMIN", "USER")
                ...
                .antMatchers(HttpMethod.POST, "/bt/edit/works/{id}").hasRole("ADMIN")
                .antMatchers(HttpMethod.OPTIONS, "/bt/edit/works/{id}").permitAll()
                .antMatchers(HttpMethod.POST, "/bt/edit/masters/{id}").hasRole("ADMIN")
                .antMatchers(HttpMethod.OPTIONS, "/bt/edit/masters/{id}").permitAll()
                .antMatchers(HttpMethod.POST, "/bt/edit/services/{id}").hasRole("ADMIN")
                .antMatchers(HttpMethod.OPTIONS, "/bt/edit/services/{id}").permitAll()
                .antMatchers(HttpMethod.POST, "/bt/edit/cars/{id}").hasRole("ADMIN")
                .antMatchers(HttpMethod.OPTIONS, "/bt/edit/cars/{id}").permitAll()
